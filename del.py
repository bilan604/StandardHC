...
.home_banner ul li.home_back1{ background:url(../images/home1.jpg) center no-repeat;}
.home_banner ul li.home_back2{ background:url(../images/home2.jpg) center no-repeat;}
...
.nav li{ width:115px; float:left; font-weight:bold; color:#fff; position:relative;}
...
.nav_s{ width:1000px; clear:both; background:url(../images/nav_back2.gif) center no-repeat; height:34px; margin:0px auto;}
.nav_s ul{ width:920px; margin:0px auto; font-family:"微软雅黑";}
.nav_s li{ width:115px; float:left; font-weight:bold; color:#fff; position:relative; padding:0px 0px 0px 1px;}
.nav_s li a{ background:url(../images/nav.gif) no-repeat; display:block; height:34px; line-height:34px;}

li.nav_1s a{ background-position:0px -72px; width:95px;}
li.nav_2s a{ background-position:-95px -72px; width:115px;}
li.nav_3s a{ background-position:-210px -72px; width:115px;}
li.nav_4s a{ background-position:-325px -72px; width:115px;}
li.nav_5s a{ background-position:-440px -72px; width:115px;}
li.nav_6s a{ background-position:-555px -72px; width:115px;}
li.nav_7s a{ background-position:-670px -72px; width:115px;}
li.nav_8s a{ background-position:-785px -72px; width:115px;}

li.nav_1s a:hover,li.nav_1s .nav_1s_hover{ background-position:0px -106px; width:95px;}
li.nav_2s a:hover,li.nav_2s .nav_2s_hover{ background-position:-95px -106px; width:115px;}
li.nav_3s a:hover,li.nav_3s .nav_3s_hover{ background-position:-210px -106px; width:115px;}
li.nav_4s a:hover,li.nav_4s .nav_4s_hover{ background-position:-325px -106px; width:115px;}
li.nav_5s a:hover,li.nav_5s .nav_5s_hover{ background-position:-440px -106px; width:115px;}
li.nav_6s a:hover,li.nav_6s .nav_6s_hover{ background-position:-555px -106px; width:115px;}
li.nav_7s a:hover,li.nav_7s .nav_7s_hover{ background-position:-670px -106px; width:115px;}
li.nav_8s a:hover,li.nav_8s .nav_8s_hover{ background-position:-785px -106px; width:115px;}
...
.nav_s li div span{ display:block; border-bottom:1px solid #5a5a5a; height:25px; font-size:12px;}
.nav_s li div span a{ height:25px; line-height:25px; padding-left:22px; width:93px; color:#fff; background:url(../images/nav_hovers.gif) repeat-x; display:block; text-align:left; font-weight:normal;}
.nav_s li div span a:hover{ color:#fff; text-decoration:underline; height:25px; line-height:25px; text-align:left; background:url(../images/nav_hovers.gif) repeat-x; padding-left:22px; width:93px;}
...
.menu li a{ background:url(../images/menu.gif) 0px 0px no-repeat; display:block; padding-left:120px; width:80px; height:28px; line-height:28px; color:#39508a;}
...
/*  右边图片样式  */
.right_img1{ background:url(../images/right_img1_s.jpg) no-repeat; width:180px; height:81px; display:block; margin-bottom:5px;}
...
.kd-content img:-moz-broken {
    ...
    <!--[if !IE]>首页头部开始<![endif]-->
    <div class="top_back">
            <h1><a href="/zh_cn/default/index.html"><img src="/static/images/logo_2.gif" border="0"></a></h1>
            <!--<h2><a href="/zh_cn/default/index.html"><img src="/static/images/33.jpg" border="0" /></a></h2>-->
            <div class="top_right2 gray_8"><a title="关注我们的新浪微博" target="_blank" href="http://weibo.com/StandardHC"><img src="/static/images/home_icon2.gif" border="0"></a><a title="关注我们的腾讯微博" target="_self" href="javascript:;"><img src="/static/images/home_icon3.gif" border="0"></a>
            <a href="javascript:void(0)" class="top_icon_s">English</a>
            <!-- <a href="" class="top_icon2">招聘</a> -->
        ...
        <ul>
            <li class="nav_1s" style="width:95px;"><a href="/zh_cn/default/index.html"></a>
                            ...
                            <div>
                                    ...
                                    <span><a href="/zh_cn/about/cultural_vision.html" style="padding-left:34px; width:81px;">愿景文化</a></span>
                                </div>
                        </li>
                    <li class="nav_3s nav_s_line"><a href="/zh_cn/service/index.html" class=""></a>
                            <div>
                                    ...
                                    <span><a href="/zh_cn/service/directors.html">董事会服务</a></span>
                                </div>
                        </li>
    ...
    <!--[if !IE]>主要内容结束<![endif]-->
    <div class="foot gray_8 clearfix"><a href="/zh_cn/statement/index.html">网站使用条款声明</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/zh_cn/sitemap/index.html">网站地图</a>&nbsp;&nbsp;|&nbsp;&nbsp;©2012 standard management ltd. All rights reserved&nbsp;&nbsp;<a href="http://www.miitbeian.gov.cn" target="_blank">沪ICP备11014438号-1</a>
