<?php
class Form_Admin_Message extends QForm
{
    /**
    ...
    {
		$config_name = 'message_form.yaml';
		
        $form = new Form_Admin_Message('Form_Admin_Message', $action);
        $filename = rtrim(dirname(__FILE__), '/\\') . DS . $config_name;
        $form->loadFromConfig(Helper_YAML::loadCached($filename));
        $form->addValidations(Message::meta());
        return $form;
    }
