<?php
// $Id: usershaveroles.php @2009 ccbox.net 1:22 2009-5-14 $

/**
 * Admin_UsersHaveRoles 封装来自 sys_acl_users_have_roles 数据表的记录及领域逻辑
 */
class UserHaveRoles extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                ...
                //'is_include' => array('readonly' => true),
             ...
             */
            //'attr_protected' => 'uid, role_id, is_include',
            'attr_protected' => '',
