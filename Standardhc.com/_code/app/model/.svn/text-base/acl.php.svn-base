    ...
    static function __define()
    {
        ...
        (
            ...
            (
                ...
                (
                    array('max_length', 20, 'namespace_name不能超过 20 个字符'),

                ),

                'controller_name' => array
                (
                    array('max_length', 20, 'controller_name不能超过 20 个字符'),

                ),

                'action_name' => array
                (
                    array('max_length', 20, 'action_name不能超过 20 个字符'),

                ),

                'acl_name' => array
                (
                    array('max_length', 60, 'acl_name不能超过 60 个字符'),
