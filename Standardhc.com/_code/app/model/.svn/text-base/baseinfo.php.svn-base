...
/**
 * Baseinfo 封装来自 baseinfo 数据表的记录及领域逻辑
 */
class Baseinfo extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'company_name' => array
                (
                    array('max_length', 255, 'company_name不能超过 255 个字符'),
                ...
                'seo_title' => array
                (
                    array('max_length', 255, 'seo_title不能超过 255 个字符'),

                ),

                'seo_keywords' => array
                (
                    array('max_length', 255, 'seo_keywords不能超过 255 个字符'),

                ),

                'seo_description' => array
                (
                    array('max_length', 255, 'seo_description不能超过 255 个字符'),

                ),

                'icp' => array
                (
                    array('max_length', 64, 'icp不能超过 64 个字符'),

                ),

                'address' => array
                (
                    array('max_length', 255, 'address不能超过 255 个字符'),

                ),

                'phone' => array
                (
                    array('max_length', 64, 'phone不能超过 64 个字符'),
